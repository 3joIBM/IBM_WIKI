...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_convertPositionTo: function(d, pos) {
		...
		var o = this.options, scroll = this.cssPosition == 'absolute' && !(this.scrollParent[0] != document) ? this.offsetParent : this.scrollParent, scrollIsRootNode = (/(html|body)/i).test(scroll[0].tagName);
